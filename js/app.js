...
$(function() {
  var TapEvent, applyEffect, cleanPage, doResize, getMenuType, h, hideMenu, lastWheel, nextPageTimer, nextSlide, pageChangeTime, prevSlide, showMenu, toggleMenu, w, wait, _ref;
  ...
  showMenu = function() {
    var h, height, left, top, w, width, _ref, _ref1;
    switch (getMenuType()) {
      case "normal":
        return $(".menu").animate({
          "left": "0"
        }, 500, "ease", function() {
          return $(".menu").removeClass("collapsed");
        });
      case "popup":
        _ref = $(".menu").offset(), width = _ref.width, height = _ref.height;
  ...
  hideMenu = function() {
    switch (getMenuType()) {
      case "normal":
        return $(".menu").animate({
          "left": "-85%"
        }, 500, "ease", $(".menu").addClass("collapsed"));
      case "popup":
        return $(".menu").animate({
          "top": "-120vh"
        }, 500, "ease", $(".menu").addClass("collapsed"));
